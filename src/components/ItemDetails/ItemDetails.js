...
class ItemDetails extends Component {
  ...
  fetchData(id, type = this.props.match.params.type) {
    if (type === "movie") {
      this.props.getMovieDetails(
        `https://api.themoviedb.org/3/movie/${id}?api_key=${this.props.apiKey}&language=en-US`
      );
      this.props.getMovieCredits(
        `https://api.themoviedb.org/3/movie/${id}/credits?api_key=${this.props.apiKey}&language=en-US`
      );
      this.props.getMovieTrailers(
        `https://api.themoviedb.org/3/movie/${id}/videos?api_key=${this.props.apiKey}&language=en-US`
      );
      this.props.getMovieReviews(
        `https://api.themoviedb.org/3/movie/${id}/reviews?api_key=${this.props.apiKey}&language=en-US`
      );
    } else if (type === "tv") {
      this.props.getTVDetails(
        `https://api.themoviedb.org/3/tv/${id}?api_key=${this.props.apiKey}&language=en-US`
      );
      this.props.getTVCredits(
        `https://api.themoviedb.org/3/tv/${id}/credits?api_key=${this.props.apiKey}&language=en-US`
      );
      this.props.getTVTrailers(
        `https://api.themoviedb.org/3/tv/${id}/videos?api_key=${this.props.apiKey}&language=en-US`
      );
      this.props.getTVReviews(
        `https://api.themoviedb.org/3/tv/${id}/reviews?api_key=${this.props.apiKey}&language=en-US`
      );
    } else if (type === "people") {
      this.props.getPeopleDetails(
        `https://api.themoviedb.org/3/person/${id}?api_key=${this.props.apiKey}&language=en-US`
      );
      this.props.getPeopleCombinedCredits(
        `https://api.themoviedb.org/3/person/${id}/combined_credits?api_key=${this.props.apiKey}&language=en-US`
      );
    }
  }
  ...
  handleShareButton = () => {
    document
      .querySelector(".item-details-header-info-share-buttons")
      .classList.toggle("item-details-header-info-share-buttons__hide");
  };
  ...
  handleFavoriteItem = (
    ...
    if (this.props.logInStatus === "APPROVED") {
      ...
      event.target
        .closest(".item-details-header-info-container-content__favorite")
        .classList.toggle(
          "item-details-header-info-container-content__favorite--active"
        );

      // Displays a warning popup if user is not approved
    } else if (this.props.logInStatus === "GUEST") {
      document
        .querySelector(".item-details-header-info-container-account-warning")
        .classList.remove(
          "item-details-header-info-container-account-warning--hide"
        );
      setTimeout(() => {
        document
          .querySelector(".item-details-header-info-container-account-warning")
        ...
        return (
          <div className="item-details-header-info-container">
            <img
              ...
              alt={this.props.movieDetails ? this.props.movieDetails.title : ""}
            />
            ...
            <div className="item-details-header-info-container-content">
              ...
              <div className="item-details-header-info-container-content-rating">
                ...
                <StarRating
                  className="item-details-header-info-container-content-rating__stars"
                  rating={
                    this.props.movieDetails
                      ? this.props.movieDetails.vote_average
                      : ""
                  ...
                  itemType="movie"
                  itemId={this.props.movieDetails.id}
                />
              </div>

              <p className="item-details-header-info-container-content__detail">
                {this.props.movieDetails ? this.props.movieDetails.status : ""}{" "}
                |{" "}
                {this.props.movieDetails.original_language
                  ? this.props.movieDetails.original_language.toUpperCase()
                  : ""}
              </p>
        ...
        return (
          <div className="item-details-header-info-container">
            <img
              ...
              alt={this.props.TVDetails ? this.props.TVDetails.title : ""}
            />

            <div className="item-details-header-info-container-content">
              <h1 className="item-details-header-info-container-content__title">
                {this.props.TVDetails ? this.props.TVDetails.name : ""}
              </h1>

              <div className="item-details-header-info-container-content-rating">
                <p className="item-details-header-info-container-content-rating__digit">
                  {this.props.TVDetails
                    ? this.props.TVDetails.vote_average
                    : ""}
                </p>
                <StarRating
                  className="item-details-header-info-container-content-rating__stars"
                  ...
                  itemType="tv"
                  itemId={this.props.TVDetails.id}
                />
              </div>

              <p className="item-details-header-info-container-content__detail">
                {this.props.TVDetails ? this.props.TVDetails.status : ""} |{" "}
                {this.props.TVDetails.original_language
                  ? this.props.TVDetails.original_language.toUpperCase()
                  : ""}
              </p>
              <p className="item-details-header-info-container-content__genre">
              ...
              <svg
                ...
                className="item-details-header-info-container-content__favorite"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
                <path d="M256 448l-30.164-27.211C118.718 322.442 48 258.61 48 179.095 48 114.221 97.918 64 162.4 64c36.399 0 70.717 16.742 93.6 43.947C278.882 80.742 313.199 64 349.6 64 414.082 64 464 114.221 464 179.095c0 79.516-70.719 143.348-177.836 241.694L256 448z" />
        ...
        return (
          <div className="item-details-header-info-container">
            <img
              ...
              alt={
                this.props.peopleDetails ? this.props.peopleDetails.name : ""
              }
            />
            ...
            <div className="item-details-header-info-container-content">
              ...
              <div className="item-details-header-info-container-content-rating">
                <p className="item-details-header-info-container-content-rating__digit">
                  {this.props.peopleDetails
                    ? Math.round(this.props.peopleDetails.popularity)
                    : ""}
                </p>
                <StarRating
                  className="item-details-header-info-container-content-rating__stars"
                  rating={
                    this.props.peopleDetails
                      ? this.props.peopleDetails.popularity
                      : ""
                  }
                  itemType="people"
                  itemId={this.props.peopleDetails.id}
                />
              </div>
              ...
              <p className="item-details-header-info-container-content__detail">
                {this.props.peopleDetails
                  ? `${
                      this.props.peopleDetails.gender === 1 ? "Female" : "Male"
                    }`
                  : ""}{" "}
                |{" "}
                {this.props.peopleDetails
                  ? this.props.peopleDetails.known_for_department
                  : ""}
              </p>
              <p className="item-details-header-info-container-content__genre">
                {this.props.peopleDetails.birthday
                  ? this.formatYearOfBirth(this.props.peopleDetails.birthday) +
                    " | " +
                    this.findAge(this.props.peopleDetails.birthday) +
                    " yo"
                  : ""}
              </p>
            </div>
      ...
      case "tv":
        return (
          <div className="item-details-main-summary">
            ...
            <p className="item-details-main-summary__content">
              {this.props.TVDetails.overview
                ? `${
                    this.props.TVDetails.overview.length > 0
                      ? this.props.TVDetails.overview
                      : "Overview not found"
                  }`
                : ""}
          ...
          <div className="item-details-main-summary">
            ...
            <p className="item-details-main-summary__content">
              {this.props.peopleDetails.biography
                ? this.shortText(this.props.peopleDetails.biography, 100)
                : ""}
            </p>
          </div>
        );
      ...
      case "movie":
        return (
          <div className="item-details-main-cast">
            <h2
              className="item-details-main-cast__title wow fadeInLeft"
              data-wow-delay=".2s"
              data-wow-duration="1s"
            >
              Cast
            ...
            <PeopleCarousel
              ...
              MDBConfig={this.props.MDBConfig}
              people={
                this.props.movieCredits.cast ? this.props.movieCredits.cast : ""
              }
            />
          </div>
        );
      ...
      case "tv":
        return (
          <div className="item-details-main-cast">
            ...
            <PeopleCarousel
              backdropUrl={
                this.props.TVDetails ? this.props.TVDetails.backdrop_path : ""
              }
              MDBConfig={this.props.MDBConfig}
              people={this.props.TVCredits ? this.props.TVCredits.cast : ""}
            />
          </div>
        );
      ...
      case "movie":
        return (
          <div className="item-details-main-trailers">
            <h2
              className="item-details-main-trailers__title wow fadeInLeft"
              data-wow-delay=".2s"
              data-wow-duration="1s"
            >
              Trailers
          ...
          <div className="item-details-main-reviews">
            ...
            {this.props.movieReviews.results.length > 0 ? (
              ...
              <div className="item-details-main-reviews-container">
                <p className="item-details-main-reviews-container__error">
                  No reviews found :(
                </p>
              </div>
            )}
      ...
      case "people":
        return (
          <div className="item-details-main-popular-roles">
            <h2
              className="item-details-main-popular-roles__title wow fadeInLeft"
              data-wow-delay=".2s"
              data-wow-duration="1s"
            >
              Popular Roles
            ...
            {this.props.peopleCombinedCredits.cast.length > 0 ? (
              this.props.peopleCombinedCredits.cast.map((role, index) =>
                index < 15 ? (
                  <div
                    key={role.title}
                    className="item-details-main-popular-roles-container"
                  >
                    <Link to={`/details/${role.media_type}/${role.id}`}>
                      <header className="item-details-main-popular-roles-container-header">
                        <img
                          className="iitem-details-main-popular-roles-container-header-image"
                          src={
                            this.props.MDBConfig.images
                              ? this.props.MDBConfig.images.secure_base_url +
                                this.props.MDBConfig.images.poster_sizes[0] +
                        ...
                        <div className="item-details-main-popular-roles-container-header-info">
                          <h3 className="item-details-main-popular-roles-container-header-info__title">
                            {role.title}
                          </h3>
                          <p className="item-details-main-popular-roles-container-header-info__character">
                            {role.character}
                          </p>
                        </div>
                      </header>
                    ...
                    <p className="item-details-main-popular-roles-container__content">
                      {this.shortText(role.overview)}
                    </p>
                  </div>
                ) : null
              )
              ...
              <div className="item-details-main-popular-roles-container">
                <p className="item-details-main-popular-roles-container__error">
                  No roles found :(
                </p>
              </div>
            )}
    ...
    return (
      <div className="item-details" id="item-details-top">
        <header
          ...
          url(${
            this.props.MDBConfig.images
              ? `${this.props.MDBConfig.images.secure_base_url}original${
                  this.props.match.params.type === "people"
                    ? `${
                        this.props.location.state
                          ? this.props.location.state.backdropUrl
                          : `${
                              this.props.peopleCombinedCredits.cast.length > 0
                                ? this.props.peopleCombinedCredits.cast[0]
                                    .backdrop_path
                                : ""
                            }`
                      }`
