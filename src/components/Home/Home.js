...
class Home extends Component {
  ...
  handleMovieFetch = () => {
    ...
    this.props.postMoviesPopular(
      `https://api.themoviedb.org/3/movie/popular?api_key=${this.props.apiKey}&language=en-US&page=1`
    );
    this.props.postMoviesNowPlaying(
      `https://api.themoviedb.org/3/movie/now_playing?api_key=${this.props.apiKey}&language=en-US&page=1`
    );
    this.props.postMoviesTopRated(
      `https://api.themoviedb.org/3/movie/top_rated?api_key=${this.props.apiKey}&language=en-US&page=1`
    );
  };

  // fetches tv data
  handleTVFetch = () => {
    this.props.postTVAiringToday(
      `https://api.themoviedb.org/3/tv/airing_today?api_key=${this.props.apiKey}&language=en-US&page=1`
    );
    this.props.postTVPopular(
      `https://api.themoviedb.org/3/tv/popular?api_key=${this.props.apiKey}&language=en-US&page=1`
    );
    this.props.postTVOnTheAir(
      `https://api.themoviedb.org/3/tv/on_the_air?api_key=${this.props.apiKey}&language=en-US&page=1`
    );
    this.props.postTVTopRated(
      `https://api.themoviedb.org/3/tv/top_rated?api_key=${this.props.apiKey}&language=en-US&page=1`
    );
  };
    ...
    if (this.props.itemType === "MOVIE") {
      movie = (
        <div>
          <ItemCarousel
            title="Upcoming"
            genres={this.props.movieGenres.genres}
          ...
          <ItemCarousel
            ...
            genres={this.props.movieGenres.genres}
            MDBConfig={this.props.MDBConfig}
            items={this.props.moviesPopular.results}
            type={this.props.itemType}
          />
          <ItemCarousel
            title="Now Playing"
          ...
          <ItemCarousel
            ...
            genres={this.props.movieGenres.genres}
            MDBConfig={this.props.MDBConfig}
            items={this.props.moviesTopRated.results}
            type={this.props.itemType}
          />
        </div>
      );
      ...
      movie = (
        <div>
          <ItemCarousel
            title="Airing Today"
            genres={this.props.TVGenres.genres}
            MDBConfig={this.props.MDBConfig}
            items={this.props.TVAiringToday.results}
            type={this.props.itemType}
          />
          <ItemCarousel
            title="Popular"
            genres={this.props.TVGenres.genres}
            MDBConfig={this.props.MDBConfig}
            items={this.props.TVPopular.results}
            type={this.props.itemType}
          />
          <ItemCarousel
            title="On The Air"
            genres={this.props.TVGenres.genres}
            MDBConfig={this.props.MDBConfig}
            items={this.props.TVOnTheAir.results}
            type={this.props.itemType}
          />
          <ItemCarousel
            title="Top Rated"
            genres={this.props.TVGenres.genres}
            MDBConfig={this.props.MDBConfig}
            items={this.props.TVTopRated.results}
            type={this.props.itemType}
          />
        </div>
      );
    ...
    return (
      <div className="home-container">
        ...
        <HomeHeader
          ...
          items={
            this.props.itemType === "TV"
              ? this.props.TVAiringToday.results
              : this.props.moviesNowPlaying.results
          }
        />
